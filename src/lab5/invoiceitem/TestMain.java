package lab5.invoiceitem;

import lab5.customerandinvoice.Customer;
import lab5.customerandinvoice.Invoice;
...
public class TestMain {
    public static void main(String[] args) {
        ...
        System.out.println("customer is: " + invoice1.getCutomer());
        ...
        System.out.println("customer's dicount is: " + invoice1.getCustomerDiscount());
        System.out.printf("amount after discount is: %.2f%n", invoice1.getAmountAfterDicount());
    }
}
